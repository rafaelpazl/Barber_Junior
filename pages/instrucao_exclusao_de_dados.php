				...
				<section id="one" class="wrapper style1 special">
					<div class="inner">
						<header class="major">
							...
							<h1>Instruções para excluir os dados do nosso sistema</h1>
							<p>Para excluir seus dados, siga estas etapas:</p>
							<ol>
								<li>Acesse a nossa página relacionado a política de privacidade</li>
								<li>Procure a opção para excluir seus dados ou informações da conta.</li>
								<li>Pronto, seus dados foram exluídos!</li>
							</ol>
							<p>Se você tiver alguma dúvida ou precisar de assistência adicional, entre em contato conosco através do nosso <a href="https://api.whatsapp.com/send?phone=5575992845592&text=Tem%20hor%C3%A1rio%20disponivel?" target="_blank" rel="noopener noreferrer">Whatsapp <span class="material-symbols-outlined">
										link
									</span></a>.</p>
							<p>Para mais informações sobre como tratamos seus dados, consulte nossa <a href="politica_de_privacidade.php">Política de Privacidade <span class="material-symbols-outlined">
										link
									</span></a>.</p>
