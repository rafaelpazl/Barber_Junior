...
if (!isset($_COOKIE['googleUserID']) || !isset($_COOKIE['facebookUserID'])) {
	echo "sem cookies"; // Encerra o script para evitar que o restante do código seja executado desnecessariamente
}
